...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Checks the output of a cjdb-contracts program.')
    parser.add_argument('--process-name',
                        type=str,
                        help='Process name as compiled by CMake.')
    parser.add_argument(
        '--debug',
        type=bool,
        default=False,
        help='Determines if the process was compiled with debugging symbols.')
    parser.add_argument('--expected-output',
                        type=str,
                        help='Expected output for the process.')
